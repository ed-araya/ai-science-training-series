...
TRACE_DIR=${TRACE_DIR_ROOT}/cuda_pt_2p8_h5_CB01_compile_E${EPOCHS}_N${NODES}_R${PPN}_$(tstamp)
## With 8-cores per rank
#TRACE_DIR=${TRACE_DIR_ROOT}/cuda_pt_2p8_h5_CB07_compile_E${EPOCHS}_N${NODES}_R${PPN}_$(tstamp)
...
mpiexec -n ${N} -ppn ${PPN} -l --line-buffer --cpu-bind ${CPU_AFFINITY} python EA_HW1_F_pytorch_2p8_ddp_hdf5_compile_prof.py \
