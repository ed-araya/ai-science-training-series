...
## EA count local rank using MPI
LOCAL_RANK_WITH_MPI = torch.cuda.device_count()
print(f"** HW Comment:")
print(f"The local rank count using torch.cuda.device_count() is: {LOCAL_RANK_WITH_MPI}")
print(f"Checking online, there seems to be no mpi4py.device_count(), thus the hint given")
print(f"in the instructions was unclear.")
##
